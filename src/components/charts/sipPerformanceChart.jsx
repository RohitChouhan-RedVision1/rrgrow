...
export function SipPerformanceChart({ piedata, startDate, endDate, title }) {
    ...
    return (
        <Card>
            <CardHeader>
                <div className="grid lg:grid-cols-7 md:grid-cols-3 gap-x-3 gap-y-2 mb-5">
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        ...
                        <h1 className="font-medium text-sm">{valuation?.investedAmount}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">Current Value</h1>
                        <h1 className="font-medium text-sm">{valuation?.currentAssetValue}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">Profit/Loss</h1>
                        <h1 className="font-medium text-sm">{valuation?.pl}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">MONTHLY SIP</h1>
                        <h1 className="font-medium text-sm">{valuation?.sipAmout}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">Current NAV</h1>
                        <h1 className="font-medium text-sm">{valuation?.currentNav}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">Absolute Return(%)</h1>
                        <h1 className="font-medium text-sm">{valuation?.absoluteReturns}</h1>
                    </div>
                    <div className="py-2 px-3 border border-stone-600 shadow shadow-emerald-100 rounded-sm text-center">
                        <h1 className="font-semibold text-sm">XIRR (%)</h1>
                        <h1 className="font-medium text-sm">{valuation?.xirrRate}</h1>
                    </div>
                </div>
