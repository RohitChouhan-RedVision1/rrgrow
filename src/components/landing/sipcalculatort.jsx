                            ...
                            {result && (
                                <div className="mt-4 flex flex-col justify-center items-center">
                                    <div className="mb-2 text-center flex items-center justify-start gap-3">
                                        ...
                                        {' '}
                                        <p className='text-xl font-extrabold text-white'>₹{result?.totalInvestment?.toLocaleString()}</p>
                                    </div>
                                    <div className="mb-5 text-center flex items-center justify-start gap-3">
                                        ...
                                        <p className='text-xl font-bold text-white'>₹{Math.floor(result.futureValue - result.totalInvestment)?.toLocaleString()}</p>
                                    </div>
                                    <div className="mb-4 text-center">
                                        <p className="text-white text-2xl mb-1">Future value of your investment </p>
                                        <p className='text-2xl font-bold text-white'>₹{result?.futureValue?.toLocaleString()}</p>
                                    </div>
                                </div>
                            )}
                        </div>
